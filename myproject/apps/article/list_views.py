...
def article_titles(request, username=None):
    ...
    if username:
        return render(request, 'article/list/author_articles.html', {'articles': articles, 'page': current_page, 'userinfo':userinfo, 'user':user, 'avatar':settings.MEDIA_URL + userinfo.avatar})
